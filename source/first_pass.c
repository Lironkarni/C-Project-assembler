...
Symbol *symbol_table_head = NULL; /* Symbol table head */
ext_list *ext_list_head=NULL; /* External label list head */
...
int first_pass(char *file)
{
    ...
    update_symbol_tabel(); /* Update addresses in symbol table after the first pass */
    second_pass(file, ext_list_head, symbol_table_head, code_image,data_image); /* Proceed to second pass */
    return 0;  /* Success */
}
